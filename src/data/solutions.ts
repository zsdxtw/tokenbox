...
export const solutionScenarios: SolutionScenario[] = [
  {
    ...
    category: "基础设施建设",
    description:
      "为政府、企业、高校提供从选址规划、供电配套、机房建设到 GPU 集群部署、组网调优的全栈智算中心建设方案。覆盖千卡到万卡级集群，交付即可投入大模型训练与推理。",
  ...
  },
  {
    ...
    category: "算力运营",
    description:
      "为拥有 GPU 设备的企业、高校、科研机构提供算力租赁运营托管服务。平台负责设备上架、模型部署、API 接口开放、用户运营与计费结算，帮助设备方快速变现闲置算力。",
