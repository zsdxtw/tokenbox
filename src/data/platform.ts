...
export const sellers: Seller[] = [
  ...
  },
  {
    ...
    certifications: ["品牌授权", "原厂保修"],
    location: "深圳·南山",
    established: "2026-01",
    description: "专注智算中心网络设备，覆盖 InfiniBand/以太网交换机、DPU、网卡、光模块与高速线缆。",
    productCount: 26,
  },
  {
    id: "slr-006",
    ...
    certifications: ["原厂授权", "ISO 9001"],
    location: "杭州·余杭",
    established: "2026-01",
    description: "企业级 SSD 与闪存介质批发商，支持集采拼单与批量阶梯折扣。",
    productCount: 22,
  },
  {
    id: "slr-007",
    ...
    type: "品牌商",
    creditRating: 5,
    transactionCount: 465,
    totalAmount: 152000000,
    certifications: ["品牌官方", "原厂保修", "信创认证"],
    location: "成都·高新",
    established: "2026-01",
    description: "华为生态授权经销商，提供昇腾 AI 服务器、鲲鹏服务器、CloudEngine 交换机与 OceanStor 存储全线产品。",
    productCount: 46,
  },
  {
    id: "slr-008",
    ...
    location: "郑州·高新",
    established: "2026-02",
    description: "超聚变数字技术官方店，提供 FusionServer 系列服务器与智算中心配套产品。",
    productCount: 18,
  },
  {
    id: "slr-009",
    ...
    certifications: ["品牌官方", "原厂保修", "液冷认证"],
    location: "北京·海淀",
    established: "2026-02",
    description: "中科曙光官方店，提供液冷 AI 服务器、曙光数创液冷冷却单元与 ParaStor 存储产品。",
    productCount: 16,
  },
  {
    id: "slr-010",
    ...
    certifications: ["品牌授权", "含安装资质"],
    location: "广州·黄埔",
    established: "2026-01",
    description: "专注算力中心供电与散热，覆盖 UPS、精密空调、液冷系统与智能 PDU，含安装一站式交付。",
    productCount: 24,
  },
  {
    id: "slr-011",
    ...
    certifications: ["原厂授权", "安装施工资质"],
    location: "苏州·工业园",
    established: "2026-01",
    description: "服务器机柜、冷热通道封闭与智能母线批发商，支持机房整体交付。",
    productCount: 20,
  },
  {
    id: "slr-012",
    ...
    certifications: ["原厂合作", "CMMI 3级"],
    location: "北京·海淀",
    established: "2026-02",
    description: "集群调度与加速栈软件服务商，提供 K8s+Volcano、Slurm、NVIDIA AI Enterprise 与 CANN 订阅部署服务。",
    productCount: 12,
  },
];
